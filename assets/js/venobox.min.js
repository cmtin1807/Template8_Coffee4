!function (e, t) {
     ...
     */let e, t, o, n, s, i, a, r, l, d, c, v, u, b, p, g, m, f, y, x, h, L, w, k, S, C, A, P, E, q, M, T, j, H, O, z,
        I, V;
    const B = document.createElement("div");
    let N, D = 0, Q = 0, X = 0, Y = !1, R = new Image, F = !1;
    const K = {
    ...
    function J() {
        return !(!r || !document.body.classList.contains("vbox-open")) && ((!r.settings.onPreClose || "function" != typeof r.settings.onPreClose || (r.settings.onPreClose(r, p, j, H), !1 !== r.settings.onPreClose)) && (document.body.removeEventListener("keydown", te), document.body.classList.remove("vbox-open"), r.settings.focusItem && r.focus(), void _({
            duration: 200,
            timing: Z,
            draw: function (e) {
    ...
    function oe() {
        ...
        e.classList.add("vbox-child"), e.style.backgroundColor = r.settings.bgcolor, e.style.transform = "scale(0.9)", e.style.transition = "transform 200ms";
        ...
        })), q && k.classList.add(q), M ? a.classList.add("vbox-fit") : a.classList.remove("vbox-fit"), _({
            duration: 200,
            timing: Z,
            draw: function (e) {
    ...
    function se(e, t, o) {
        ...
        let s = function (e) {
            let t, o, n;
            if (o = e.match(/(https?:\/\/)?((www\.)?(youtube(-nocookie)?|youtube.googleapis)\.com.*(v\/|v=|vi=|vi\/|e\/|embed\/|user\/.*\/u\/\d+\/)|youtu\.be\/)([_0-9a-z-]+)/i), o && o[7]) t = "youtube", n = o[7]; else {
        ...
        if ("vimeo" == s.type || "youtube" == s.type) {
            ...
            "vimeo" == s.type ? i = "https://player.vimeo.com/video/" : "youtube" == s.type && (i = "https://www.youtube.com/embed/"), x = '<div class="venoratio venoratio-' + t + '"><iframe webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="' + i + s.id + a + '"></iframe></div>'
    ...
    function de(e) {
        ...
        let i = k.querySelector(".vbox-next"), a = k.querySelector(".vbox-prev");
    ...
    function ce(t) {
        ...
        let s = "bar" === t.settings.titleStyle ? "100%" : "auto", i = "pill" === t.settings.titleStyle ? "5em" : "0",
            a = "bar" === t.settings.shareStyle ? "100%" : "auto", r = "pill" === t.settings.shareStyle ? "5em" : "0",
    ...
    function ve() {
        ...
        switch (r.dataset.vbtype) {
            case"iframe":
                e = E, t = A, a.classList.add("vbox-loading"), x = '<div class="venoratio venoratio-' + t + '"><iframe src="' + e + '"></iframe></div>', a.classList.remove("vbox-loading"), ne("animated");
                break;
            case"inline":
                !function (e) {
    ...
    const pe = function (e) {
        ...
        return t.close = J, t.next = $, t.prev = ee, t.open = be, t.settings = o, function (e, t) {
